  ...
  return (
    <Section tone="default" spacing="default" id="downloads">
      <Container width="wide">
        <div className="grid min-h-[36rem] gap-12 rounded-[2rem] bg-inverse p-8 text-inverse-text md:p-14 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          ...
          <div>
            ...
            <form className="mt-8 rounded-[1.5rem] bg-white/12 p-6">
              <p className="font-semibold">Enter your details</p>
              <div className="mt-5 grid gap-3">
                <input
                  className="min-h-12 rounded-[var(--radius-medium)] border border-white/10 bg-black px-4 text-sm text-inverse-text placeholder:text-white/35"
                  name="name"
